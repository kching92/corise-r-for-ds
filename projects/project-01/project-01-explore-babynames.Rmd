...
4. Popular Letter Combinations: What are the most popular letter combinations?
    - The top 3 most popular first and last letter combinations by sex (First Letter & Last Letter):
        - Females: A & A, C & E, E & A
        - Male: A & N, C & N, J & N
5. Vowels vs Consonants: Are there naming trends in usage of vowels and consonants?
    - In the 60s male names that start and end with consonants were the most popular (~75%)
    - Females names that start and end with vowels were popular in the last 1800s and early 1900s and are making a comeback in more recent years (2000s)
    - It is the most uncommon for male names to start and end with vowels
    - It is the most uncommon for female names to start with a vowel and end with a consonant
