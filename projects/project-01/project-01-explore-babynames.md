...
1.  Popular Names: What are the most popular names?
    - The top 5 most popular names by sex:
      - Female: Emma, Olivia, Sophia, Isabella, Ava
      - Male: Noah, Liam, William, Mason, Jacob
2.  Trendy Names: What are trendy names?
    - The top 5 most trendy names by sex:
      - Female: Katinam Ashanti, Marquite, Everleigh, Miley
      - Male: Luka, Atlas, Jase, Legend, Jayceon
3.  Popular Letters: What are the most popular letters in names?
    - The top 3 most popular first letters by sex:
      - Females, A, E, M
      - Males: J, A, L
4.  Popular Letter Combinations: What are the most popular letter
    combinations?
    - The top 3 most popular first and last letter combinations by sex
      (First Letter & Last Letter):
      - Females: A & A, C & E, E & A
      - Male: A & N, C & N, J & N
5.  Vowels vs Consonants: Are there naming trends in usage of vowels and
    consonants?
    - In the 60s male names that start and end with consonants were the
      most popular (\~75%)
    - Females names that start and end with vowels were popular in the
      last 1800s and early 1900s and are making a comeback in more
      recent years (2000s)
    - It is the most uncommon for male names to start and end with
      vowels
    - It is the most uncommon for female names to start with a vowel and
...
tbl_names_popular |> 
  ...
  labs(
    title = 'Top 5 Baby Names by Sex (2011-2020)',
    subtitle = 'The top 5 baby names by sex based on number of births between the years of 2011 and 2020',
    caption = 'Bar Chart of the top 5 baby names faceted by sex between 2011 and 2020',
    x = 'Number of Births',
    y = 'Name'
  ) +
...
tbl_names_by_letter |> 
  ...
  filter(year == 2020) |>
  # Initialize a ggplot of pct_births vs. first letter
  ...
  labs(
    title = 'Births by First Letter (2020)',
    subtitle = 'The total births by first letter by sex based on number of births in the year of 2020',
    caption = 'Bar Chart of the total births by first letter faceted by sex in 2020',
    x = 'Number of Births',
    y = 'First Letter'
  ) +
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = "The percentage births based on number of births",
      caption = "Line chart of percentage of births by year",
      x = "Year",
...
tbl_names_by_first_and_last_letter |> 
  ...
  labs(
      title = glue::glue("Percentage of Births by First and Last Letter (2021)"),
      subtitle = "The percentage of births based on number of births by first and last letter in the year 2021",
      caption = "Heatmap of percent of births by first and last letter",
      x = "First Letter",
      y = 'Last Letter'
    ) +
...
tbl_names_vowel_consonant |> 
  ...
  # Add labels (title, subtitle, caption, x, y)
  labs(
      title = "Percentage of Births by First and Last Letter Type",
      subtitle = "The percentage of births based on number of births by first and last letter type",
      caption = "Heatmap of percent of births by first and last letter",
      x = "Year",
      y = 'Percentage of Births'
    ) +
